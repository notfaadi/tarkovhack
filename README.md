# TarkovHack — Marketing Site

Static Astro 7 site for [tarkovhack.org](https://tarkovhack.org). Primary SEO keyword: **tarkov hacks** (secondary: escape from tarkov cheats, eft hacks, aimbot, ESP).
...
1. Create a Cloudflare Pages project named **tarkovhack**
2. Connect this repo or upload `dist/` after `npm run build`
3. Build command: `npm run build`
4. Output directory: `dist`
5. Add custom domain **tarkovhack.org** (apex) and redirect **www** → apex
...
Private — for tarkovhack.org deployment only.

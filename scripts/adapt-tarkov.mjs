#!/usr/bin/env node
/**
 * One-time migration: Warzone Hacks → TarkovHack (Escape from Tarkov).
 * Domain: tarkovhack.com
...
const REPLACEMENTS = [
	['https://warzonehacks.net', 'https://tarkovhack.com'],
	['https://www.warzonehacks.net', 'https://www.tarkovhack.com'],
	['www.warzonehacks.net', 'www.tarkovhack.com'],
	['warzonehacks.net', 'tarkovhack.com'],
	['support@warzonehacks.net', 'support@tarkovhack.com'],
	['support@warzonescheats.net', 'support@tarkovhack.com'],
	['warzonescheats.net', 'tarkovhack.com'],
	['warzonescheats.com', 'tarkovhack.com'],
	['warzonescheats.xyz', 'tarkovhack.com'],
	['/products/warzone', '/products/tarkov'],
	['project-name=warzonehacks', 'project-name=tarkovhack'],
	['project-name=warzonescheats', 'project-name=tarkovhack'],
	['name = "warzonehacks"', 'name = "tarkovhack"'],
	['name = "warzonescheats"', 'name = "tarkovhack"'],
	...
	['Call of Duty Warzone', 'Escape from Tarkov'],
	['Warzone Hacks', 'TarkovHack'],
	['Warzone Cheats', 'TarkovHack'],
	['Warzone cheats', 'TarkovHack'],
	...
	['call-of-duty-warzone', 'escape-from-tarkov'],
	['Buy Warzone Hacks', 'Buy TarkovHack'],
	['Warzone', 'Tarkov'],
	['warzone', 'tarkov'],
];
...
async function main() {
	console.log('Adapting Warzone Hacks → TarkovHack (tarkovhack.com)...\n');

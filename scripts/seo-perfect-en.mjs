...
const replacements = [
	...
	['TarkovHack & TarkovHack', 'TarkovHack'],
	[
		'covering both TarkovHack and TarkovHack search intent',
		'covering both “TarkovHack” and “escape from TarkovHack” search intent',
	],
	[
		'also searched as TarkovHack and tarkov cheat.',
		'built for Escape from Tarkov on Windows PC.',
	],
	[
		'TarkovHack vs TarkovHack — same stack, clear pages',
		'How this TarkovHack pillar fits nearby pages',
	],
	[
		'Searchers use TarkovHack and TarkovHack interchangeably. This pillar focuses on hacks language; the',
	...
	['best TarkovHack guide', 'TarkovHack pillar'],
	['best TarkovHack checklist', 'TarkovHack checklist'],
	['best TarkovHack', 'TarkovHack'],
	[

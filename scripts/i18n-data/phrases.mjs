...
export const phrases = {
	es: {
		buy: 'Comprar TarkovHack', undetected: 'indetectables', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'Contacta support@tarkovhack.com para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter TarkovHack', undetected: 'indétectables', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'Contactez support@tarkovhack.com pour le support ou les demandes légales.',
	},
	de: {
		buy: 'TarkovHack kaufen', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar TarkovHack', undetected: 'indetectáveis', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'Contacte support@tarkovhack.com para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista TarkovHack', undetected: 'indetectable', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'Contatta support@tarkovhack.com per supporto o richieste legali.',
	},
	nl: {
		buy: 'TarkovHack kopen', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup TarkovHack', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить TarkovHack', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'TarkovHack satın al', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'Destek ve yasal sorular için support@tarkovhack.com.',
	},
	ar: {
		buy: 'اشترِ TarkovHack', undetected: 'غير مكتشف', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'TarkovHackを購入', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'サポート・法務: support@tarkovhack.com',
	},
	ko: {
		buy: 'TarkovHack 구매', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => '지원 및 법무: support@tarkovhack.com',
	},
	zh: {
		buy: '购买 TarkovHack', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => '支持与法务：support@tarkovhack.com',
	},
	hi: {
		buy: 'TarkovHack खरीदें', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'सहायता: support@tarkovhack.com',
	},
	id: {
		buy: 'Beli TarkovHack', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ TarkovHack', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua TarkovHack', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити TarkovHack', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit TarkovHack', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără TarkovHack', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com pentru suport și legal.',
	},
	sv: {
		buy: 'Köp TarkovHack', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Tarkov',
		...
		legal: () => 'support@tarkovhack.com för support och juridik.',
	},
};

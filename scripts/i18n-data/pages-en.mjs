...
export const enPages = {
	home: {
		...
		description:
			'TarkovHack for Windows PC — ESP, soft aim, radar, and BattlEye updates. Compare plans and buy.',
		h1: 'TarkovHack — Undetected ESP, Wallhack & Aimbot',
		intro:
			'TarkovHack is the undetected TarkovHack package for Windows PC — built for Escape from Tarkov on Windows PC. Tarkov esp wallhack, 2D radar, and tarkov aimbot with BattlEye maintenance after every major patch.',
		...
		sections: [
			section(
				'Why players choose TarkovHack in 2026',
	...
	'tarkov-esp': {
		...
		description:
			'Tarkov ESP for Windows PC — player boxes, loot markers, and distance readouts. Part of our undetected TarkovHack for Escape from Tarkov.',
		h1: 'Tarkov ESP — Player Boxes & Wallhack',
		intro:
			'Tarkov esp visibility tools for raid and scav-run. Read enemy squads, PMCs, Scavs, loot, and distance before you commit — toggleable tarkov esp wallhack overlays bundled in our TarkovHack package.',
	...
	'tarkov-aimbot': {
		...
		description:
			'Tarkov aimbot with soft aim tuning for Windows PC. FOV, bone priority, and hotkeys bundled with ESP boxes in our TarkovHack package.',
	...
	features: {
		...
		description:
			'Full TarkovHack feature list: ESP boxes, soft aim, radar, and toggles for Windows PC. Review controls before checkout.',
		h1: 'TarkovHack Features — Full Control List',
		intro:
			'Every ESP wallhack, radar hack, and Aimbot control included in the TarkovHack package for Tarkov on Windows PC — with BattlEye maintenance after major patches.',
		...
		sections: [
			...
			section(
				...
				`Monitor ${EXT.status} on patch days, then confirm rebuild notes before you queue. Setup and billing help lives on <a href="/support/">Support</a> and support@tarkovhack.com.`,
	...
	pricing: {
		...
		description:
			'TarkovHack pricing: $35/month or $150 lifetime for ESP, soft aim, and radar on Windows PC. Instant delivery — pick a plan.',
		h1: 'TarkovHack Pricing — Monthly & Lifetime',
		intro:
			'Choose monthly or lifetime access to undetected TarkovHack — ESP wallhack, radar hack, and Aimbot for Tarkov on Windows PC. Instant digital delivery after payment.',
		...
		sections: [
			section(
				'Monthly and lifetime TarkovHack plans',
	...
	setup: {
		...
		description:
			'Set up TarkovHack on Windows PC — activate ESP boxes, soft aim profiles, and . Check BattlEye updates before your first queue.',
		h1: 'TarkovHack Setup — Windows PC Guide',
		intro:
			'Install and configure TarkovHack for Tarkov on Windows 10 or 11. Activate your license, load ESP wallhack and Aimbot profiles, and verify BattlEye maintenance status before queueing.',
	...
	updates: {
		...
		description:
			'TarkovHack update log: BattlEye rebuilds for ESP boxes, soft aim, and radar on Windows PC. Check status before queueing after patches.',
		...
		sections: [
			section(
				...
				`Use ${EXT.status} for Battlestate Games platform health and this page for TarkovHack build status — both matter on big update days.`,
	...
	faq: {
		...
		description:
			'TarkovHack FAQ: ESP boxes, soft aim, BattlEye maintenance, and pricing for PC. Clear answers before you buy.',
		h1: 'TarkovHack FAQ — Common Questions',
		intro:
			'Answers about undetected TarkovHack — ESP wallhack, radar hack, Aimbot, BattlEye maintenance, checkout, and Tarkov compatibility on Windows PC.',
		...
		sections: [
			...
			section(
				'Are TarkovHack undetected in 2026?',
	...
	support: {
		...
		description:
			'Contact TarkovHack support for licenses, ESP setup, soft aim profiles, and on Windows PC. Include your order ID for faster help.',
		h1: 'TarkovHack Support — Contact Us',
		intro:
			'Get help with TarkovHack licenses, checkout, ESP wallhack setup, Aimbot profiles, and BattlEye maintenance for Tarkov on Windows PC.',
	...
	undetected: {
		...
		description:
			'Undetected TarkovHack with BattlEye maintenance for ESP boxes, soft aim, and radar on Windows PC. Check status before you queue.',
		h1: 'Undetected TarkovHack — BattlEye Maintenance',
		intro:
			'How TarkovHack stays maintained for Tarkov after BattlEye anti-cheat patches — ESP wallhack, radar hack, and Aimbot rebuilds for Windows PC.',
		...
		sections: [
			section(
				'What undetected means for TarkovHack',
	...
	wallhack: {
		...
		description:
			'Tarkov wallhack ESP with player boxes and loot markers for Windows PC. Undetected TarkovHack — learn overlays and buy.',
	...
	radar: {
		...
		description:
			'Tarkov radar hack for flank awareness on Windows PC. Bundled with ESP boxes, soft aim, and radar in our TarkovHack package.',
	...
	'battleye': {
		...
		description:
			'How TarkovHack rebuild after BattlEye patches — ESP boxes, soft aim, and radar maintenance for Windows PC. Read before queueing.',
		h1: 'BattlEye Bypass — TarkovHack Maintenance',
		intro:
			'Understand BattlEye anti-cheat maintenance for TarkovHack — how ESP wallhack, radar hack, and Aimbot rebuild after Tarkov security updates.',
		...
		sections: [
			section(
				...
				`TarkovHack monitors BattlEye patch notes and Tarkov seasonal updates from ${EXT.tarkov} to schedule module reviews.`,
	...
	'cheats-2026': {
		...
		description:
			'Best TarkovHack 2026: ESP boxes, soft aim, and radar for Windows PC. Undetected TarkovHack with BattlEye maintenance — compare and buy.',
		h1: 'TarkovHack 2026 — ESP, Soft Aim & Radar',
		intro:
			'The 2026 TarkovHack package for Tarkov — undetected ESP wallhack, radar hack, and Aimbot with BattlEye maintenance, instant delivery, and Windows PC support.',
		...
		sections: [
			section(
				'Why TarkovHack buyers choose TarkovHack in 2026',
	...
	hacks: {
		...
		description:
			'TarkovHack for Windows PC: undetected ESP wallhack, radar hack, and Aimbot with BattlEye maintenance. Compare TarkovHack options and buy the full package.',
		h1: 'TarkovHack — Undetected ESP, Aimbot & Wallhack',
		intro:
			'TarkovHack for raid and scav-run combine ESP wallhack visibility, 2D radar-style threat cues, and Aimbot controls in one undetected Windows PC license — maintained after BattlEye anti-cheat patches. This is the pillar guide for TarkovHack in 2026.',
		...
		sections: [
			section(
				'What TarkovHack include in 2026',
			...
			section(
				'How this TarkovHack pillar fits nearby pages',
			...
			section(
				'TarkovHack vs single-feature tools',
			...
			section(
				'Undetected TarkovHack with BattlEye maintenance',
				...
				`See ${EXT.battleye} for anti-cheat background and our <a href="/updates/">BattlEye bypass guide</a> for the practical workflow. Pair with <a href="/tarkov-cheats/">undetected TarkovHack</a> for status language buyers expect.`,
	...
	'mod-menu': {
		...
		description:
			'Tarkov mod menu for in-match toggles — ESP boxes, soft aim, radar, and on Windows PC. Undetected TarkovHack package.',
	...
	'soft-aim': {
		...
		description:
			'Tarkov soft aim settings for natural tracking on Windows PC. Smoothness, FOV, and bone priority — included in our TarkovHack with ESP boxes.',
	...
	'best-cheats': {
		...
		description:
			'Best TarkovHack for 2026: ESP boxes, soft aim, and BattlEye maintenance on Windows PC. Use this checklist before checkout.',
		h1: 'Best TarkovHack — 2026 Buyer Guide',
		intro:
			'Compare the TarkovHack for Tarkov in 2026 — undetected ESP wallhack, radar hack, and Aimbot in one maintained package with BattlEye anti-cheat rebuilds and instant delivery.',
		...
		sections: [
			section(
				'What makes the TarkovHack in 2026',
			...
			section(
				'Best TarkovHack feature checklist',
	...
	'aimbot-hack': {
		...
		description:
			'Tarkov aimbot hack with soft aim for Windows PC. FOV, bone priority, and hotkeys — bundled with ESP boxes in our TarkovHack package.',
	...
	'esp-hack': {
		...
		description:
			'Tarkov ESP hack with player boxes and loot markers for Windows PC. Undetected TarkovHack with — see overlays and buy.',
	...
	'unlock-all': {
		...
		description:
			'Tarkov unlock all explained vs real TarkovHack — ESP boxes, soft aim, and radar for Windows PC. Know what you are buying.',
		h1: 'Tarkov Unlock All — What Players Search For',
		intro:
			'Tarkov unlock all is a common search term for Tarkov — this page clarifies what unlock-all tools claim versus the ESP wallhack, radar hack, and Aimbot tools TarkovHack actually provides on Windows PC.',
		...
		sections: [
			...
			section(
				'Buying TarkovHack for the right reasons',
	...
	privacy: {
		...
		description:
			'Privacy policy for TarkovHack. How we handle support emails, order data, and checkout for TarkovHack licenses on tarkovhack.com.',
		h1: 'Privacy Policy',
	...
	refund: {
		...
		description:
			'Refund policy for TarkovHack. Digital delivery terms and eligibility for TarkovHack packages with ESP, soft aim, and radar.',
		h1: 'Refund Policy',
		intro:
			'Refund terms for TarkovHack licenses — ESP wallhack, radar hack, and Aimbot packages purchased through checkout for Tarkov.',
	...
	terms: {
		...
		description:
			'Terms of use for tarkovhack.com and TarkovHack licenses. Usage rules, anti-cheat risk, and liability for Windows PC cheats.',
		h1: 'Terms of Use',
